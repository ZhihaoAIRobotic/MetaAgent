...
# client = Client(host='localhost', port=60062, protocol='http')
# response = client.post(on='post', inputs=DocList[TextDoc]([TextDoc(text='what')]), return_type=DocList[TextDoc])
# print(response[0])
# print(f'Text: {response[0].text}')
client = Client(host='0.0.0.0:60596', protocol='http')
response = client.post(on='/post', inputs=DocList[TextDoc]([TextDoc(text='why')]), return_type=DocList[TextDoc])
print(response[0])
print(f'Text: {response[0].text}')