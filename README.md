...
```
1. The CURL will response a link that generated by Minio S3. You can copy this link and check the response content in the web browser.
...
<video src='Docs/resource/old version demo.mp4' width=180/>
