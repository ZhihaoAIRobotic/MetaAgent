...
class LLamaLLM(BaseAnswer, LLM, ABC):
    ...
    def history_to_text(self, query, history):
        """
        History dialogue soft prompt
             This code first defines a function called history_to_text that converts self.history
             The array is converted to the desired text format. Then, we will format the historical text
             Then use self.encode to convert it to a vector representation.
             Finally, the historical dialogue vectors are concatenated with the current input dialogue vectors.
        :return:
        """
        formatted_history = ''
    ...
    def prepare_inputs_for_generation(self,
        ...
        """
        Pre-generating the attention mask and a tensor of indices for each position in the input sequence
        # TODO
        :return:
        """
    ...
    def generatorAnswer(self, prompt: str,
        ...
        # TODO:
        #  It is necessary to implement the chat dialogue module
        #  and attention model. Currently _call is the LLM extended API of langchain.
        #  The default mode is no prompt word mode. If you need to operate the attention model,
        #  you can refer to the implementation of chat_glm
